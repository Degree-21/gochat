...
func TestOCRIDCardFront(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRIDCardFront(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRIDCardFrontByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRIDCardFrontByURL(OCRPhoto, "ENCODE_URL", result))
...
func TestOCRIDCardBack(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRIDCardBack(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRIDCardBackByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRIDCardBackByURL(OCRPhoto, "ENCODE_URL", result))
...
func TestOCRBankCard(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRBankCard(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRBankCardByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRBankCardByURL(OCRPhoto, "ENCODE_URL", result))
...
func TestOCRPlateNumber(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRPlateNumber(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRPlateNumberByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRPlateNumberByURL(OCRPhoto, "ENCODE_URL", result))
...
func TestOCRDriverLicense(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRDriverLicense(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRDriverLicenseByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRDriverLicenseByURL(OCRPhoto, "ENCODE_URL", result))
...
func TestOCRVehicleLicense(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRVehicleLicense(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRVehicleLicenseByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRVehicleLicenseByURL(OCRPhoto, "ENCODE_URL", result))
...
func TestOCRBusinessLicense(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRBusinessLicense(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRBusinessLicenseByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRBusinessLicenseByURL(OCRPhoto, "ENCODE_URL", result))
...
func TestOCRComm(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRComm(OCRPhoto, "../mock/test.jpg", result))
...
func TestOCRCommByURL(t *testing.T) {
	...
	err := mp.Do(context.TODO(), "ACCESS_TOKEN", OCRCommByURL(OCRPhoto, "ENCODE_URL", result))
